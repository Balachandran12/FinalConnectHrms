    ...
    <div class=" flex mt-5" x-data="{
        ...
        <div class=" w-1/3" x-data="{
            ...
            <ul class="">
                ...
                <li @click="val = 2" :class="val == '2' ? active : inactive">Job Info</li>
                <li @click="val = 3" :class="val == '3' ? active : inactive">Employment Info</li>
                ...
                <li @click="val = 8" :class="val == '8' ? active : inactive">Onboarding</li>
                <li @click="val = 9" :class="val == '9' ? active : inactive">Offboarding</li>
            </ul>
        </div>
        {{-- List Section end  --}}
        ...
        <div class=" w-full bg-white">
            <div class=" border border-[#D1D5D8] rounded w-full pb-6">
                <div class="">
            ...
            <div class=" flex items-center gap-x-2 mt-6">
                <button class=" text-white font-bold bg-[#104FFF] px-[26px] py-2 rounded-lg">Save</button>
